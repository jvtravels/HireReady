...
export const LANDING_FAQS = [
  ...
  { question: "Does it work on mobile?", answer: "Yes, on any modern browser. For the best experience during mock interviews, use a laptop or desktop with a microphone — but the app works fully on mobile too." },
