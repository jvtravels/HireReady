...
export const LANDING_FAQS = [
  { question: "Is HireStepX free to use?", answer: "Yes! Our free plan includes 3 full AI mock interview sessions with real-time feedback, score tracking, and detailed performance reports. No credit card required. After that, you can buy single sessions for just ₹10 each, or upgrade to a weekly (₹49/week) or monthly (₹149/month) plan." },
