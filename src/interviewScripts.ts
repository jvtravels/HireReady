...
export const scriptsByType: Record<string, InterviewStep[]> = {
  ...
  "salary-negotiation": [
    { type: "intro", aiText: "Good to see you again. We've completed all the interview rounds, and the team was impressed. I'm here to discuss the offer details. Let me walk you through the package we've put together.", thinkingDuration: 500, speakingDuration: 5500, waitForUser: true },
    { type: "question", aiText: "We'd like to offer you the position with a CTC of 18 lakhs per annum. That breaks down to 14.5 lakhs base salary, a 10% performance bonus, and standard benefits including health insurance for you and your family. How does this align with your expectations?", thinkingDuration: 600, speakingDuration: 5500, waitForUser: true, scoreNote: "Focus on: not accepting immediately, expressing enthusiasm without committing, asking for time to review" },
    { type: "question", aiText: "I appreciate you sharing that. Before we go further, what is your current compensation, and what range were you expecting for this role? I want to make sure we can find a number that works for both sides.", thinkingDuration: 700, speakingDuration: 4500, waitForUser: true, scoreNote: "Focus on: anchoring high with market data, framing value not needs, avoiding revealing current salary too early" },
    { type: "question", aiText: "I hear you. That's above our initial band. We could stretch to 21 lakhs CTC, but that's genuinely our ceiling for this level. We could also look at a joining bonus of 1.5 lakhs to bridge the gap. Would that work?", thinkingDuration: 700, speakingDuration: 5000, waitForUser: true, scoreNote: "Focus on: not accepting first counter, negotiating beyond salary (ESOP vesting, flexible work, learning budget), maintaining leverage without being adversarial" },
    { type: "question", aiText: "Let's discuss the full package then. Beyond base and bonus, we offer ESOPs worth approximately 2 lakhs per year vesting over 4 years, a ₹50,000 annual learning budget, and flexible work 3 days a week. What other elements matter to you, and what would make this a clear yes?", thinkingDuration: 700, speakingDuration: 5500, waitForUser: true, scoreNote: "Focus on: total compensation thinking, prioritizing what matters most, professional framing of asks" },
    { type: "closing", aiText: "Good discussion. You handled the pressure well and demonstrated solid negotiation instincts. Key takeaway: always lead with enthusiasm, then negotiate on data. Focus on the full package, not just base salary, and remember — the best outcome is one where both sides feel they won.", thinkingDuration: 800, speakingDuration: 6000, waitForUser: true },
  ],
};
...
const miniQuestionsByType: Record<string, QuestionBank[]> = {
  ...
  "salary-negotiation": [
    ...
    { q: "We can add ESOPs worth approximately ₹3 LPA vesting over 4 years, or a 10% higher base salary instead. Which would you prefer and why?", qResume: "Given your career stage after being {title}, would you prefer ESOPs worth ₹3 LPA/year vesting over 4 years, or a 10% higher base? Walk me through your thinking.", scoreNote: "Compensation structure understanding, risk assessment, long-term thinking" },
