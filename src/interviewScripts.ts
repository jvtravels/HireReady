...
export const scriptsByType: Record<string, InterviewStep[]> = {
  ...
  "salary-negotiation": [
    ...
    { type: "question", aiText: "We'd like to offer you the position. The base compensation is 12 lakhs per annum with standard benefits. How does that sound to you?", thinkingDuration: 600, speakingDuration: 3500, waitForUser: true, scoreNote: "Focus on: not accepting immediately, asking for time, showing enthusiasm without committing" },
    ...
    { type: "question", aiText: "That's above our initial budget. We could potentially stretch to 14 lakhs per annum but that's really our limit. Would you accept at that number?", thinkingDuration: 700, speakingDuration: 4500, waitForUser: true, scoreNote: "Focus on: negotiating beyond salary (equity, bonus, PTO, flexibility), not accepting first counter" },
