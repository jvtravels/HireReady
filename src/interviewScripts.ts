...
export const scriptsByType: Record<string, InterviewStep[]> = {
  ...
  teaching: [
    ...
    { type: "closing", aiText: "Thank you. That's everything I had for you today — generating your detailed report now. Stay on this screen for a moment.", thinkingDuration: 800, speakingDuration: 4500, waitForUser: false },
  ],
  "panel": [
  ...
  "salary-negotiation": [
    ...
    { type: "question", aiText: "So based on your experience and our internal bands, we're offering you ₹18 LPA as your total CTC. That includes base, variable pay, and standard benefits. I think it's a strong offer for this level. What are your initial thoughts on that number?", thinkingDuration: 600, speakingDuration: 5500, waitForUser: true, scoreNote: "Phase: offer-presentation. Evaluate: Did they accept too quickly? Did they ask clarifying questions? Did they express interest without committing? Did they anchor high?" },
