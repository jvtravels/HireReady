...
export const scriptsByType: Record<string, InterviewStep[]> = {
  ...
  "salary-negotiation": [
    ...
    { type: "question", aiText: "We've put together an offer for this role based on our internal bands and market benchmarks. I'd like to walk you through the number and the overall package structure — but before I get into the specifics, how are you feeling about the opportunity so far?", thinkingDuration: 600, speakingDuration: 5500, waitForUser: true, scoreNote: "Phase: offer-reaction. Evaluate: Did they accept too quickly? Did they ask clarifying questions? Did they express interest without committing?" },
