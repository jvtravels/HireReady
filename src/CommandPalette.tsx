...
export default function CommandPalette({ onStartSession, onExport }: { onStartSession: () => void; onExport: () => void }) {
  ...
  const commands: Command[] = useMemo(() => [
    ...
    { id: "nav-sessions", label: "Go to Sessions", section: "Navigation", icon: <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg>, action: () => nav("/sessions"), keywords: "history list" },
