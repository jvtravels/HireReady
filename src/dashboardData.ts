...
export const STORAGE_KEY = "hireready_dashboard";
export const RESULTS_KEY = "hireready_sessions";
...
export function loadState(): PersistedState {
  ...
  try {
    const authRaw = localStorage.getItem("hireready_auth");
    if (authRaw) {
...
export function generateReport(userName: string, stats: { sessionsCompleted: number; avgScore: number; hoursLogged: number }, sk: SkillData[], sessions: DashboardSession[]) {
  ...
  return `HIREREADY — PROGRESS REPORT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Candidate: ${userName}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Generated by HireReady Interviews AI
