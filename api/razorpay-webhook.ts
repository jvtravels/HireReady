      ...
      try {
        await fetch("https://api.resend.com/emails", {
          ...
          body: JSON.stringify({
            ...
            html: `<p>Hi ${safeName}, your HireReady <strong>${tier}</strong> plan is now active until ${end.toLocaleDateString("en-IN", { day: "numeric", month: "long", year: "numeric" })}.</p><p><a href="${APP_URL}/dashboard">Start Practicing</a></p>`,
          }),
        });
      } catch {}
    }
